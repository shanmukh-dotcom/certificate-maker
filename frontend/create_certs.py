...
files = {
    'src/api/certificates.ts': '''import { apiClient } from './client';
...
''',
    ...
    'src/features/certificates/CertificateManager.tsx': '''import { useState } from 'react';
                ...
                <tr key={cert.certificate_id} className="border-b border-slate-50 last:border-0 hover:bg-slate-50/50 transition-colors">
                  ...
                  <td className="py-4 px-6 text-right">
                    <div className="flex items-center justify-end space-x-2">
                      <button className="p-2 text-slate-400 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors group relative" title="Download PDF">
                        <Download size={16} />
                      </button>
