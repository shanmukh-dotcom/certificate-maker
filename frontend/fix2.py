          ...
          <div className="col-span-2 space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-4 gap-4">
                <div onClick={() => navigate(/participants?event=)} className="bg-blue-50/50 hover:bg-blue-50 border border-blue-100 rounded-3xl p-5 cursor-pointer transition-colors group">
                ...
                <div onClick={() => navigate(/templates/new?event=)} className="bg-purple-50/50 hover:bg-purple-50 border border-purple-100 rounded-3xl p-5 cursor-pointer transition-colors group">
                ...
                <div onClick={() => navigate(/generation?event=)} className="bg-green-50/50 hover:bg-green-50 border border-green-100 rounded-3xl p-5 cursor-pointer transition-colors group">
                ...
                <div onClick={() => navigate(/certificates?event=)} className="bg-orange-50/50 hover:bg-orange-50 border border-orange-100 rounded-3xl p-5 cursor-pointer transition-colors group">
